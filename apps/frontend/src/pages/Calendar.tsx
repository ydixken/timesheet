...
import { formatDecimalHours, groupEntriesByDate, parseHoursToMinutes } from '../lib/time'
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-terminal-text-bright font-mono text-sm min-w-[10rem] text-center">
          {monthName}
        </span>
